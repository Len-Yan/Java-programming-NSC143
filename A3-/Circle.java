...
public class Circle extends AbstractShape{
 // private int x_axis;
  ...
  /**
   * sets this Shape to be selected (true) or deselected (false) and add a border to it
   * @param b the state wish to set.
   */ 
   //public void setSelected(boolean b) {
  //  super.setSelected(b);
 //   g.setColor(Color.white);
 //   g.fillOval(x_axis ,y_axis ,2*height +1 ,2*height +1);
  //   }
  ...
  public String toString() {
    return ("The center of the circle is " + (x_axis+height) +", "+(y_axis+height) +". It's radius " + height + ". it's Color: "+ super.getColor()) ;
