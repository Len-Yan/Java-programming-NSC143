 ...
 * modified 2/7/04, 2/15/07, 11/8/09, 2/12/12, 10/27/14 by vo
 */
public class SimpleLinkedList<E> implements List<E>
{
   ...
   * @param c the collection used to initialize the new ArrayList
   ...
   * Throws an IllegalArgumentExcpetion if pos less than 0 
   * or pos greater than or equal to size( ).
   * @return item stored at given position
   */
   ...
   * Throws an IllegalArgumentException if pos less than 0 
   * or pos greater than size( ) or obj == null.
   ...
   * @throws IllegalArgumentException if pos less than 0 
   * or pos greater than size( ) or obj == null
   */
   ...
   *  precondition: pos greater than or equal to 0 and less than size( ) 
   */
