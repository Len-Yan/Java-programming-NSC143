...
public class QuickSort{
  ...
  /** Partitions, or moves the data in the array around a pivot value. All values 
    * lower than the pivot value will be in lower indices than the pivot value. All 
    * values higher than the pivot value will be in higher indices than the pivot value.
  ...
  public static void main(String[] args) {
    ...
    // fencepost pattern: print the first element w/o a comma (assumes values.length > 0)
